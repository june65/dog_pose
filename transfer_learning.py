...
train_gen = train_datagen.flow_from_directory('./data/train_data_set/',
                                                 target_size = (300, 300),
                                                 batch_size = 32,
                                                 class_mode = 'categorical',subset='training')
val_gen  = train_datagen.flow_from_directory('./data/train_data_set/',
                                                 target_size = (300, 300),
                                                 batch_size = 32,
...
# Step 1 - Convolution
cnn.add(tf.keras.layers.Conv2D(filters=32, kernel_size=3, activation='relu', input_shape=[300, 300, 3]))
